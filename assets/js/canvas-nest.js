...
this.el=t,this.c=h({zIndex:-1,opacity:.5,color:"0,0,0",pointColor:"0,0,0",count:99},n),this.canvas=this.newCanvas(),this.context=this.canvas.getContext("2d"),this.clipCanvasToCircle(),this.points=this.randomPoints(),this.current={x:null,y:null,max:2e4},this.all=this.points.concat([this.current]),this.bindEvent(),this.requestFrame(this.drawCanvas)}return p(e,[{key:"bindEvent",value:function(){var e=this;d(this.el,function(){e.canvas.width=333,e.canvas.height=333}),this.onmousemove=window.onmousemove,window.onmousemove=function(t){var rect = e.canvas.getBoundingClientRect();e.current.x=t.clientX-rect.left,e.current.y=t.clientY-rect.top,e.onmousemove&&e.onmousemove(t)},this.onmouseout=window.onmouseout,window.onmouseout=function(){e.current.x=null,e.current.y=null,e.onmouseout&&e.onmouseout()}}},{key:"newCanvas",value:function(){"static"===getComputedStyle(this.el).position&&(this.el.style.position="relative");var e,t=document.createElement("canvas");return t.style.cssText="display:block;position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);height:333px;width:333px;border-radius:50%;overflow:hidden;pointer-events:none;z-index:"+(e=this.c).zIndex+";opacity:"+e.opacity,t.width=333,t.height=333,this.el.appendChild(t),t}},{key:"clipCanvasToCircle",value:function(){this.context.beginPath();this.context.arc(166.5, 166.5, 166.5, 0, Math.PI * 2);this.context.clip();}},{key:"requestFrame",value:function(e){var t=this;this.tid=v(function(){return e.call(t)})}},
    
        {key:"drawCanvas",value:function(){var e=this,t=this.context,n=this.canvas.width,o=this.canvas.height,i=this.current,r=this.points,a=this.all;t.clearRect(0,0,n,o);var s=void 0,u=void 0,c=void 0,l=void 0,d=void 0,v=void 0;
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function updateLineColor() {
                    ...
                    t.strokeStyle = "rgba(" + rgbColor + "," + (c + .2) + ")";
                }
        ...
        r.forEach(function(r,f){
            ...
            t.fillStyle="rgba("+e.c.pointColor+")",t.fillRect(r.x-.5,r.y-.5,1,1);
